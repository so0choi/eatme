...
import {
  ...
  WasteReasonChart,
  WasteTrendPoint,
} from '@/components/insights/WasteCharts';
    ...
    <div className="max-w-7xl space-y-8 pt-2">
      <section className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <h1 className="font-display text-4xl font-bold leading-none text-primary">손실 레포트</h1>
        </div>
      </section>
      ...
      <section className="rounded-3xl bg-surface-container-lowest p-7 shadow-ambient">
        <DailyWasteTrend data={dailyWaste} />
      </section>
      ...
      <section className="grid grid-cols-1 gap-6 xl:grid-cols-[1fr_22rem]">
        <article className="rounded-3xl bg-surface-container-lowest p-7 shadow-ambient">
          <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
            <div>
              ...
              <h2 className="font-display text-3xl font-bold text-on-surface">월간 폐기 트렌드</h2>
            </div>
        ...
        <article className="rounded-3xl bg-surface-container-lowest p-7 shadow-ambient">
          <div className="mb-6">
            ...
            <h2 className="font-display text-3xl font-bold text-on-surface">폐기 사유 분석</h2>
          </div>
      ...
      <section className="overflow-hidden rounded-3xl bg-surface-container-lowest shadow-ambient">
        <div className="flex flex-wrap items-center justify-between gap-4 px-7 py-6">
          <div>
            ...
            <h2 className="font-display text-3xl font-bold text-on-surface">폐기 로그 상세</h2>
          </div>
          <button
            type="button"
            disabled
            ...
            <tbody>
              {recentLogs.length > 0 ? (
                recentLogs.map((item) => {
                  ...
                  return (
                    <tr key={item.id} className="bg-surface-container-lowest">
                      ...
                      <td className="px-7 py-4 font-display text-lg font-bold text-tertiary-container">
                ...
                <tr>
                  <td
                    colSpan={5}
                    className="px-7 py-12 text-center text-sm text-on-surface-variant"
                  >
                    아직 폐기된 식재료가 없습니다.
                  </td>
                </tr>
